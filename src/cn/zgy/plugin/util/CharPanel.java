...
import cn.zgy.plugin.entity.CharObj;
...
public class CharPanel implements Runnable {
    ...
    private Set<CharObj> charSet = new HashSet<>();
    private List<CharObj> bufferList = new ArrayList<>();
            ...
            if(GlobalVar.font != null){
                ...
                while (it.hasNext()){
                    ...
                    if(obj.isAdd()){ //如果是添加到文本框
                        if(obj.getSize() <= minFontSize){//字体到达最小时消失
